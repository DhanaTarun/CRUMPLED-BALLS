class Dustbin{
    ...
    display(){
        fill("white");
        rect(this.bodyb.position.x,this.bodyb.position.y,this.bodyb.width,this.bodyb.height,this.bodyb.options);
        rect(this.bodyb.position.x-(this.bodyb.width/2)),(this.bodyb.position/2);
        rect(this.bodyb.position.x+(this.bodyb.width/2)),(this.bodyb.position/2);
    }
}
